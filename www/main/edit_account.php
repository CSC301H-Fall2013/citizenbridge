					...
					<div id="wb-main-in">
						...
						<div class="span-8">
							...
							<form action="edit_account.php" method="post"> 
								First Name:<br /> 
								<input type="text" name="first" value ="<?php echo htmlentities($_SESSION['user']['first'], ENT_QUOTES, 'UTF-8'); ?>" maxlength="50"/> <span id="firstError"></span>
								<br /><br />
								Last Name:<br /> 
								<input type="text" name="last" value="<?php echo htmlentities($_SESSION['user']['last'], ENT_QUOTES, 'UTF-8'); ?>"/ maxlength="50"> <span id="lastError"></span>
								<br /><br /> 
								Postal Code:<br /> 
								<input type="text" name="postalcode" value="<?php echo htmlentities($_SESSION['user']['postalcode'], ENT_QUOTES, 'UTF-8'); ?>" maxlength="6"/> <span id="postalError"></span>
								<br /><br /> 								
								E-Mail Address:<br /> 
								<input type="text" name="email" value="<?php echo htmlentities($_SESSION['user']['email'], ENT_QUOTES, 'UTF-8'); ?>" maxlength="50"/> <span id="emailError"></span>	
								<br /><br /> 
								Password:<br /> 
