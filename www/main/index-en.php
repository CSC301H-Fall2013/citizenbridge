...
<head>
	...
	<title> Citizenbridge Main</title>
...
<div id="wb-body">
	...
	<section>
		...
		<div id="wet-fullhd-in">
				<ul>
				<!-- No french support for the time being. LEO-->
	...
	<div id="wet-psnb"><h2>Site menu</h2><div id="wet-psnb-in"><div class="wet-boew-menubar mb-mega"><div>
			...
			<ul class="mb-menu" data-ajax-replace="includes/projectmenu-en.txt">
				<li><div><a href="">Button 1</a></div></li>
				<li><div><a href="">Button 2</a></div></li>
				<li><div><a href="">Button 3</a></div></li>
			</ul>
			</div></div></div>
	</div>
...
<!-- 	888888  dP"Yb   dP"Yb  888888 888888 88""Yb 
	...
	<div id="wb-foot"><div id="wb-foot-in"><footer><h2 id="wb-nav">Footer</h2>
		...
		<nav role="navigation"><div id="wet-sft"><h3>Site footer</h3><div id="wet-sft-in">
			...
			<section> <!-- Contact Us -->
				<div class="span-2"><h4 class="wet-col-head">Contact us</h4>
					<ul>
